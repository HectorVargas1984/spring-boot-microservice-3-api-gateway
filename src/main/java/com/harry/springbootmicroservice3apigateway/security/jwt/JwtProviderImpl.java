...
public class JwtProviderImpl implements JwtProvider{
    ...
    @Override
    public String generateToken(UserPricipal auth){
    ...
    public Authentication getAuthentication(HttpServletRequest request){
        ...
        UserDetails userDetails = UserPricipal.builder()
                .username(username)
    ...
    private Claims extractClaims(HttpServletRequest request){
        String token = SecurityUtils.extracAuthTokenFromRequest(request);
